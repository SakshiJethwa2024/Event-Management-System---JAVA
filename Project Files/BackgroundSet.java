...
public class BackgroundSet extends JPanel implements ActionListener
{
	...
	JTextField get;
    double abprice = 8000,cbprice = 7500,sbprice = 6500,nbprice = 0,btotal;
	String ans;
	JButton book;
	DecorStorage dcs;
	...
	BackgroundSet()
	{
		...
		setBackground(new Color(193,179,215));
		  ...
		  title = new JLabel("SELECT YOUR BACKGROUND FRAMESET TYPE !!");
		  title.setBounds(180,50,650,30);
		  title.setFont(f);
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		{
			get.setText(""+abprice+" /-");
			ans = "AESTHETIC BACKGROUND FRAMSESET FOR RS."+abprice+"/- \n"+adesc.getText();
			btotal = abprice;
		}
		else if(ae.getSource() == col)
		{
			get.setText(""+cbprice+" /-");
			ans = "COLORFUL VIBRANT BACKGROUND FRAMSESET FOR RS."+cbprice+"/- \n"+cdesc.getText();
			btotal = cbprice;
		}
		else if(ae.getSource() == sim)
		{
			get.setText(""+sbprice+" /-");
			ans = "SIMPLE BACKGROUND FRAMSESET FOR RS."+sbprice+"/- \n"+sdesc.getText();
			btotal = sbprice;
		}
		else if(ae.getSource() == none)
		{
			get.setText(""+nbprice+" /-");
			ans = "NO BACKGROUND FRAMSESET";
			btotal = nbprice;
		}
		if(ae.getActionCommand() == "BOOK")
		{
			...
			else
			{
					...
					if(choice == 0)
					{
						...
						DecorTab.totaldecorprice += btotal;
